...
from src.config import DATASET_FOLDER_PREPROCESSED, DATASET_FOLDER_WEIGHTS_FINAL, DATASET_SUB_FOLDER_VALIDATION, \
    TRAIN_MODEL_FILE, TRAIN_STRATEGY, DATASET_CATEGORIES
from src.helper import log


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights_name', type=str, default=TRAIN_STRATEGY)
    parser.add_argument('--weights_folder', type=str, default=DATASET_FOLDER_WEIGHTS_FINAL)
...
def main(weights_name, weights_folder, validation_h5, verbose):
...
if __name__ == '__main__':
    args = parse_args()
    main(args.weights_name, args.weights_folder, args.validation_h5, args.verbose)
